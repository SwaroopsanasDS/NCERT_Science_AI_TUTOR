...
LLM_REPO_ID = "google/flan-t5-base"  # lightweight, works on HF Hub
HF_TOKEN = os.getenv("HF_TOKEN")

if not HF_TOKEN:
    raise ValueError("Set HF_TOKEN in Streamlit secrets.")

def load_vectorstore(persist_directory: str = FAISS_DIR) -> FAISS:
    """Load precomputed FAISS index using HuggingFace embeddings."""
